CREATE OR REFRESH MATERIALIZED VIEW gold_race_analysis(
    ...
    demographic_group STRING COMMENT "Specific race",
...
COMMENT "Aggregate data from the different races grouped by season, respiratory diagnosis, and visit type"
AS
SELECT
  season,
...
FROM silver_health
WHERE demographic_category = 'Race/Ethnicity'
